...
function ProjectSection() {
  return (
    <article>
      ...
      <h2>Moticon 3D Shoe</h2>
      <h4>
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras amet elit
        arcu proin massa sed urna urna. Faucibus ac semper libero arcu turpis.
        Facilisis ipsum viverra ridiculus urna imperdiet. Sed ullamcorper et sed
        mauris velit eget risus, volutpat vel. Faucibus viverra sed eros,
        facilisi aliquam lorem. Nibh blandit et blandit justo molestie euismod
        sit netus.
      </h4>
    </article>
  );
